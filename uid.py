...
if __name__ == "__main__":
    ...
    selected_lang = "Mandarin"  # Change language here
    ...
    info_trajs, UID_dev = calc_info_trajectory(selected_terms, selected_need_probs, selected_langname,
                                               100, False, 2, mand_alt=selected_alternate_order, mand=selected_attested_order)

    area = calc_cumulative_surprisal(
        eng_alt=info_trajs[selected_langname_alt], eng=info_trajs[selected_langname])

    UID_dict = UID_dev[selected_langname]
    UID_dict_alt = UID_dev[selected_langname_alt]

    plot_mini(info_trajs, selected_langname)
