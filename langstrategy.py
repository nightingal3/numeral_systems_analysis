...
class Language:
    ...
    def add_rule(self, form, numeral, op):
        self.forest.append(language_tree.make_tree(
            form, numeral, op, self.num_only))

        def first_three(self, terms):
            for c in range(3):
                self.forest.append(language_tree.make_tree(
                    terms[c], c+1, "ONE", self.num_only))
...
def ain():
    ...
    forest.append(language_tree.make_tree(
        "u", ["tu", "re", "ine", "asikne"], "MEM"))
    forest.append(language_tree.make_tree("v", [
                  "sine", "tu", "re", "ine", "asikne", "iwan", "arwan", "tupesan", "sinepesan"], "MEM"))
...
def brs():
    ...
    ulim = 5
    forest = []
    terms = ["sig-u/o", "hua-ra", "idia-ra",
             "babarirak-u/o", "kohobokarak-u/o"]
...
def eng():
    ...
    forest.append(language_tree.make_tree("w", [
                  "one", "two", "three", "four", "five", "six", "seven", "eight", "nine"], "MEM"))
...
def geo():
    ...
    ulim = None
    forest = []
    terms = ["ert-i", "or-i", "sam-i", "otx-i", "xut-i",
             "ekvs-i", "svid-i", "rva", "cxra", "at-i"]
    ...
    forest.append(language_tree.make_tree(
        ["t", "-", "w", "met"], ["w", "at-i"], "ADD"))
    forest.append(language_tree.make_tree(
        ["ca", "-", "met", "-i"], ["sam-i", "at-i"], "ADD"))
    forest.append(language_tree.make_tree(
        ["cvid", "-", "met", "-i"], ["svid-i", "at-i"], "ADD"))
    forest.append(language_tree.make_tree(
        ["cxra", "-", "met", "-i"], ["cxra", "at-i"], "ADD"))
    forest.append(language_tree.make_tree("oc-i", ["or-i", "at-i"], "MUL"))
    forest.append(language_tree.make_tree(
        ["or", "-", "m", "-", "oc-i"], ["or-i", "oc-i"], "MUL"))
    forest.append(language_tree.make_tree(
        ["sam", "-", "oc-i"], ["sam-i", "oc-i"], "MUL"))
    forest.append(language_tree.make_tree(
        ["otx", "-", "m", "-", "oc-i"], ["otx-i", "oc-i"], "MUL"))
    forest.append(language_tree.make_tree(
        ["v", "da", "-", "u"], ["v", "u"], "ADD"))
...
def hpd():
    ...
    forest = successors(forest, terms, 3, 5)
    forest.append(language_tree.make_tree(
        ["cap", "cob", "popog"], ["?aedapuh", "?ayup"], "ADD"))
    forest.append(language_tree.make_tree(
        ["u", "cob", "cakget"], ["?u", "?aedapuh"], "ADD"))
    forest.append(language_tree.make_tree(
        ["cob", "ni-", "hu?"], ["?aedapuh", "ko?ap"], "MUL"))
    forest.append(language_tree.make_tree(
        ["v", "jib", "cakget"], ["v", "cob ni-hu?"], "ADD"))
    forest.append(language_tree.make_tree(
        ["?ayup", "jib", "hu?"], ["?aedapuh", "mora?ap"], "MUL"))
    forest.append(language_tree.make_tree(
        ["jib", "ni-", "hu?"], ["?aedapuh", "babni"], "MUL"))
    forest.append(language_tree.make_tree("jib ni-hu?", [21, 100], "HIG"))
    forest.append(language_tree.make_tree(
        "u", ["ko?ap", "mora?ap", "babni"], "MEM"))
    forest.append(language_tree.make_tree(
        "v", ["form(another)", "ko?ap", "mora?ap", "babni"], "MEM"))
...
def imo():
    ...
    ulim = 5
    forest = []
    terms = ["mugasl", "sabla", "sabla mugo",
             "sabla sabla", "sabla sabla mugo"]
...
def mnd():
    ...
    ulim = None
    forest = []
    terms = ["yil", "er4", "san1", "si4", "wu3",
             "liu4", "qil", "ba1", "jiu3", "shi2"]
...
def wch():
    ...
    ulim = 10
    forest = []
    terms = ["wenyala", "tagw", "najtefwayal", "fwantes ihi", "qwe wenyal", "ipofwuj",
             "ipofwustoj", "ipofwusfwaya el", "ipofwusfwantes ihi", "oqwecho taqs"]
...
def wsk():
    ...
    forest.append(language_tree.make_tree(
        ["w", "-", "w", "itoketa"], ["w-w", "itoketa"], "ADD"))
    forest.append(language_tree.make_tree(
        ["iteltoke", "-", "iteltoke", "-", "itelala"], ["iteltoke-iteltoke", "itelala"], "ADD"))
    forest.append(language_tree.make_tree(
        ["kuting", "dilisan", "sa", "itelala", "-", "itelala"], ["itelala-itelala-itoketa", "itelala-itelala"], "ADD"))
    forest.append(language_tree.make_tree(
        ["kuting", "dilisan", "-", "dilisan"], ["itelala-itelala-itoketa", "itelala"], "MUL"))
    forest.append(language_tree.make_tree(
        "kuting dilisan-dilisan", [11, 100], "HIG"))
