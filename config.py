...
need_probs = dict(
	...
	template = parse_need_prob("data/need_probs/total_need_prob_num.csv"),
	f_np_mnd = parse_need_prob("data/need_probs/chinese_need_prob.csv"),
	f_np_ger = parse_need_prob("data/need_probs/german_need_prob.csv"),
	f_np_spa = parse_need_prob("data/need_probs/spanish_need_prob.csv"),
	f_np_ita = parse_need_prob("data/need_probs/italian_num_pos.csv"),
	f_np_fre = parse_need_prob("data/need_probs/french_need_prob.csv")
)
